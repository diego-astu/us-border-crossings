...
possible_hour_formats = ['%H','%I']
possible_minute_formats = ['%M']
possible_second_formats = ['%S']
possible_AMPM_formats = ['%p']
...
with open(input_filepath, newline='',mode = 'r') as csvfile:
	...
	for row in reader:
		...
		yearmonth_as_datetime0 = StringToDate_ManyFormats(str_in = row['Date'].replace(',',''))
